...
class TestImages(TestCase):
    def setUp(self):
        self.location = Location(name='Nairobbery')
        self.location.save_location()

        self.category = Category(name='Comic')
    ...
    def test_search_image_by_location(self):
        self.image_test.save_image()
        found_images = self.image_test.filter_by_location(location='Nairobbery')
...
class TestLocation(TestCase):
    ...
    def test_update_location(self):
        new_location = 'Krypton'
        self.location.update_location(self.location.id, new_location)
        changed_location = Location.objects.filter(name='Krypton')
